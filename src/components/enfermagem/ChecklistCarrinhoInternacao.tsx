...
import {
  ShieldAlert, Plus, Search, Clock, CheckCircle2, AlertTriangle, Package
} from 'lucide-react';
...
export function ChecklistCarrinhoInternacao() {
  const [registros, setRegistros] = useLocalStorage<RegistroCarrinho[]>('enf-checklist-carrinho-internacao', []);
  ...
  const handleSalvar = () => {
    ...
    setDialogOpen(false);
    toast.success('Checklist do carrinho de internação registrado com sucesso');
  };
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold flex items-center gap-2">
            ...
            Checklist do Carrinho de Internação
          </h3>
