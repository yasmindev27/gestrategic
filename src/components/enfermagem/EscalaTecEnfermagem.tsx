...
const ESCALA_CONFIGS: Record<EscalaTipo, EscalaTipoConfig> = {
  ...
  enfermeiros: {
    titulo: 'ESCALA DE SERVIÇO DE ENFERMEIROS SUPERVISOR',
    tituloCard: 'Escala de Enfermeiros',
    registroLabel: 'COREN-MG',
    pdfFilename: 'Escala_Enfermeiros',
    setorCodes: [
      { code: '', label: 'Folga', color: 'bg-gray-50 text-gray-400' },
      { code: 'L', label: 'Líder de Plantão', color: 'bg-emerald-100 text-emerald-800' },
      { code: 'U', label: 'Urgência', color: 'bg-red-100 text-red-800' },
      { code: 'I', label: 'Internação', color: 'bg-purple-100 text-purple-800' },
      { code: 'C1', label: 'Classificação 01', color: 'bg-blue-100 text-blue-800' },
      { code: 'C2', label: 'Classificação 02', color: 'bg-sky-100 text-sky-800' },
      { code: 'SCIRAS', label: 'SCIH', color: 'bg-teal-100 text-teal-800' },
      { code: 'AP', label: 'Apoio', color: 'bg-amber-100 text-amber-800' },
      { code: 'AF', label: 'Afastamento Justificado', color: 'bg-gray-200 text-gray-700' },
    ],
    grupos: [
      { value: 'noturno_impar', label: 'Noturno (Ímpares)', horario: '19:00 AS 07:00' },
      { value: 'noturno_par', label: 'Noturno (Pares)', horario: '19:00 AS 07:00' },
  ...
  radiologia: {
    ...
    setorCodes: [
      { code: '', label: 'Folga', color: 'bg-gray-50 text-gray-400' },
      { code: 'LM', label: 'Licença Maternidade', color: 'bg-pink-100 text-pink-800' },
      { code: 'P', label: 'Plantão 24 Horas', color: 'bg-red-100 text-red-800' },
      ...
      { code: 'D', label: 'Dia 07:00-19:00', color: 'bg-yellow-100 text-yellow-800' },
      { code: 'N', label: 'Noite 19:00-07:00', color: 'bg-indigo-100 text-indigo-800' },
    ],
    grupos: [
      { value: 'noturno_impar', label: 'Noturno (Ímpares)', horario: '19:00 AS 07:00' },
      { value: 'noturno_par', label: 'Noturno (Pares)', horario: '19:00 AS 07:00' },
