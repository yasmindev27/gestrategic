              ...
              <div className="flex flex-col gap-2">
                {navLinks.map((link) => (
                  <a 
                    key={link.label}
                    href={link.href} 
                    className="text-sm text-white/80 hover:text-white py-2 px-2 rounded-lg hover:bg-white/5 transition-colors"
            ...
            <div className="hidden lg:flex justify-center items-center relative">
              <div className="relative w-[400px] h-[400px]">
                ...
                <svg viewBox="0 0 400 400" className="w-full h-full drop-shadow-2xl">
                  ...
                  {/* Main building - Back */}
                  <path d="M160 280 L160 140 L240 100 L320 140 L320 280 L240 320 L160 280Z" 
                        fill="url(#buildingGradient1)" stroke="#5ba3d9" strokeWidth="1.5"/>
                  
                  {/* Main building - Front left */}
                  <path d="M80 240 L80 100 L160 60 L160 200 L80 240Z" 
                        fill="url(#buildingGradient2)" stroke="#5ba3d9" strokeWidth="1.5"/>
                  
                  {/* Main building - Front right */}
                  <path d="M160 200 L160 60 L240 100 L240 240 L160 200Z" 
                        fill="url(#buildingGradient3)" stroke="#5ba3d9" strokeWidth="1.5"/>
                  
                  {/* Tower */}
                  <path d="M180 140 L180 40 L220 60 L220 160 L180 140Z" 
                        fill="url(#towerGradient)" stroke="#5ba3d9" strokeWidth="1.5"/>
                ...
                <div className="absolute bottom-16 left-4 w-12 h-12 rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center animate-pulse shadow-lg" style={{ animationDelay: '0.5s' }}>
