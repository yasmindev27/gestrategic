...
export const useModules = () => {
  ...
  const moduleAccess = useMemo(() => ({
    ...
    faturamento: isAdmin || isFaturamento || isRecepcao || isEnfermagem || isCoordenadorEnfermagem || isNir || isGerenteAdministrativo,
    ...
    restaurante: isAdmin || isRestaurante || isEnfermagem || isSupervisorOperacional,
    rhdp: isAdmin || isRHDP || isGerenteAdministrativo,
    assistenciaSocial: isAdmin || isAssistenciaSocial || isEnfermagem || isCoordenadorEnfermagem,
    qualidade: isAdmin || isQualidade || isCoordenadorMedico || isFarmaceuticoRT,
    recepcao: isAdmin || isRecepcao,
    tecnicoTI: isAdmin || isTI,
    tecnicoManutencao: isAdmin || isManutencao || isSupervisorOperacional,
    tecnicoEngenharia: isAdmin || isEngenhariaCinica,
    medicos: isAdmin || isMedicos || isCoordenadorMedico,
    rouparia: isAdmin || isRouparia || isSupervisorOperacional,
    admin: isAdmin,
    gerencia: isAdmin || isGestor || isGerenteAdministrativo,
    logs: isAdmin,
    agenda: true,
    equipe: isAdmin || isGestor || isGerenteAdministrativo,
    chat: true,
    abrirChamado: true,
    colaborador: true,
    lms: true,
    segurancaPatrimonial: isAdmin || isSeguranca || isSupervisorOperacional,
